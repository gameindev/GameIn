...
import { OfferingBaseService } from 'src/offerings/providers/offering.base.service';
import { OfferingOffersService } from 'src/offerings/offering-offers/providers/offering-offers.service';
import { OfferingPriceService } from 'src/offerings/offering-price/providers/offering-price.service';
import { Offering } from 'offerings.entity.full';
import { OfferingOffers } from 'src/offerings/offering-offers/offering-offers.entity';
import { CreateOfferingBundleDto } from 'src/offerings/dtos/post-offering-bundle.dto';
import { CreateOfferingDto } from 'src/offerings/dtos/post-offering.dto';
import { FindOfferingsParams } from 'src/offerings/enums/offering-type.enum';
        ...
        return this.dataSource.transaction(async (manager) => {
            ...
            if (dto.offers?.length) {
                const offersPayload = dto.offers.map(o => ({
                    ...o,
                    // TODO fix the offering.id issue
