import{p as it,u as ot,j as a,T as q,A as at,d as O,F as ae,L as ce,s as I,r as j,C as ct,D as lt}from"./index-Ddh2FbSx.js";import{G as ut}from"./gamein-logo-OLN3yQ-G.js";import{T as z}from"./Title-BF2Ea30k.js";var Re={root:"m_849cf0da"};const dt={underline:"hover"},fe=it((e,t)=>{const{underline:s,className:r,unstyled:n,mod:i,...o}=ot("Anchor",dt,e);return a.jsx(q,{component:"a",ref:t,className:at({[Re.root]:!n},r),...o,mod:[{underline:s},i],__staticSelector:"Anchor",unstyled:n})});fe.classes=Re;fe.displayName="@mantine/core/Anchor";const ht=O.div`
  width: 100%;
  height: 100%;
  display: flex;
  align-items: center;
