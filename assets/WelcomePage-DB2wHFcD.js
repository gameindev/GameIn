import{p as it,u as ot,j as a,q as at,d as O,L as ae,r as j}from"./index-BdKYZ-eS.js";import{G as ct}from"./gamein-logo-OLN3yQ-G.js";import{T as z}from"./Title-B-hr11WK.js";import{F as ce}from"./Flex-wkfrIo-V.js";import{T as $,B as E}from"./Button-Bhqaz8qy.js";import{I as lt}from"./IconChevronUp-DtfamcWr.js";import{I as ut}from"./IconChevronDown-DJQLAwyA.js";import"./createReactComponent-vGlhThBW.js";var Ie={root:"m_849cf0da"};const dt={underline:"hover"},fe=it((e,t)=>{const{underline:s,className:r,unstyled:n,mod:i,...o}=ot("Anchor",dt,e);return a.jsx($,{component:"a",ref:t,className:at({[Ie.root]:!n},r),...o,mod:[{underline:s},i],__staticSelector:"Anchor",unstyled:n})});fe.classes=Ie;fe.displayName="@mantine/core/Anchor";const ht=O.div`
  width: 100%;
  height: 100%;
  display: flex;
  align-items: center;
