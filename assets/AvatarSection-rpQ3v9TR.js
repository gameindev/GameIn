import{d as b,j as o,t as g}from"./index-Ddh2FbSx.js";import{H as $}from"./HexContainer-CYqX8Osk.js";import{R as y}from"./modal-BrqPe0S_.js";import{E as A}from"./EditAvator-DzLDPkaX.js";const M=({mainRadius:e=30,roundingRadius:t=10,rotated:n=!1,precision:s=20}={})=>{const x=60/s,h=e+t,a=i=>i*Math.PI/180,p=[];for(let i=0;i<6;i++){const r=i*60+(n?-90:0),u=50+h*Math.cos(a(r)),f=50+h*Math.sin(a(r));for(let c=0;c<=s;c++){const m=r+(c-s/2)*x,j=u+t*Math.cos(a(m)),v=f+t*Math.sin(a(m));p.push(`${j}% ${v}%`)}}return`polygon(${p.join(", ")})`},k=b.div`
