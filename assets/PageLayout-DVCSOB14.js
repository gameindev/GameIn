import{f as P,u as V,j as e,B as z,e as J,U as X,x as Z,b as q,c as Q,y as Y,z as e1,v as C,k as d,n as s1,l as t1,w as a1,s as g,O as o1}from"./index-CkKlCP49.js";import{c as i1,s as r1,A as n1,a as l1}from"./authSelector-CSECTd-H.js";import{c as c1}from"./createLucideIcon-Bdz_0BOg.js";import{T as u}from"./Text-CqPV5nKJ.js";import{g as d1,U as m1}from"./user-round-C9r-v7Xz.js";import{B as H}from"./Button-0bCqRMvz.js";import{c as p1}from"./create-safe-context-cF-8AV8j.js";import{u as C1,a as h1,b as x1}from"./DirectionProvider-CDWv60ca.js";function D(s,a){return t=>{if(typeof t!="string"||t.trim().length===0)throw new Error(a);return`${s}-${t}`}}const[v1,A]=p1("Tabs component was not found in the tree");var w={root:"m_89d60db1","list--default":"m_576c9d4",list:"m_89d33d6d",tab:"m_4ec4dce6",panel:"m_b0c91715",tabSection:"m_fc420b1f",tabLabel:"m_42bbd1ae","tab--default":"m_539e827b","list--outline":"m_6772fbd5","tab--outline":"m_b59ab47c","tab--pills":"m_c3381914"};const f1={},O=P((s,a)=>{const t=V("TabsList",f1,s),{children:i,className:l,grow:m,justify:c,classNames:n,styles:p,style:f,mod:h,...x}=t,r=A();return e.jsx(z,{...x,...r.getStyles("list",{className:l,style:f,classNames:n,styles:p,props:t,variant:r.variant}),ref:a,role:"tablist",variant:r.variant,mod:[{grow:m,orientation:r.orientation,placement:r.orientation==="vertical"&&r.placement,inverted:r.inverted},h],"aria-orientation":r.orientation,__vars:{"--tabs-justify":c},children:i})});O.classes=w;O.displayName="@mantine/core/TabsList";const g1={},R=P((s,a)=>{const t=V("TabsPanel",g1,s),{children:i,className:l,value:m,classNames:c,styles:n,style:p,mod:f,keepMounted:h,...x}=t,r=A(),b=r.value===m,j=r.keepMounted||h||b?i:null;return e.jsx(z,{...x,...r.getStyles("panel",{className:l,classNames:c,styles:n,style:[p,b?void 0:{display:"none"}],props:t}),ref:a,mod:[{orientation:r.orientation},f],role:"tabpanel",id:r.getPanelId(m),"aria-labelledby":r.getTabId(m),children:j})});R.classes=w;R.displayName="@mantine/core/TabsPanel";const u1={},$=P((s,a)=>{const t=V("TabsTab",u1,s),{className:i,children:l,rightSection:m,leftSection:c,value:n,onClick:p,onKeyDown:f,disabled:h,color:x,style:r,classNames:b,styles:j,vars:B,mod:T,tabIndex:_,...E}=t,I=J(),{dir:S}=C1(),o=A(),y=n===o.value,M=k=>{o.onChange(o.allowTabDeactivation&&n===o.value?null:n),p==null||p(k)},L={classNames:b,styles:j,props:t};return e.jsxs(X,{...E,...o.getStyles("tab",{className:i,style:r,variant:o.variant,...L}),disabled:h,unstyled:o.unstyled,variant:o.variant,mod:[{active:y,disabled:h,orientation:o.orientation,inverted:o.inverted,placement:o.orientation==="vertical"&&o.placement},T],ref:a,role:"tab",id:o.getTabId(n),"aria-selected":y,tabIndex:_!==void 0?_:y||o.value===null?0:-1,"aria-controls":o.getPanelId(n),onClick:M,__vars:{"--tabs-color":x?Z(x,I):void 0},onKeyDown:i1({siblingSelector:'[role="tab"]',parentSelector:'[role="tablist"]',activateOnFocus:o.activateTabWithKeyboard,loop:o.loop,orientation:o.orientation||"horizontal",dir:S,onKeyDown:f}),children:[c&&e.jsx("span",{...o.getStyles("tabSection",L),"data-position":"left",children:c}),l&&e.jsx("span",{...o.getStyles("tabLabel",L),children:l}),m&&e.jsx("span",{...o.getStyles("tabSection",L),"data-position":"right",children:m})]})});$.classes=w;$.displayName="@mantine/core/TabsTab";const F="Tabs.Tab or Tabs.Panel component was rendered with invalid value or without value",b1={keepMounted:!0,orientation:"horizontal",loop:!0,activateTabWithKeyboard:!0,allowTabDeactivation:!1,unstyled:!1,inverted:!1,variant:"default",placement:"left"},j1=Q((s,{radius:a,color:t,autoContrast:i})=>({root:{"--tabs-radius":e1(a),"--tabs-color":Z(t,s),"--tabs-text-color":d1(i,s)?Y({color:t,theme:s,autoContrast:i}):void 0}})),v=P((s,a)=>{const t=V("Tabs",b1,s),{defaultValue:i,value:l,onChange:m,orientation:c,children:n,loop:p,id:f,activateTabWithKeyboard:h,allowTabDeactivation:x,variant:r,color:b,radius:j,inverted:B,placement:T,keepMounted:_,classNames:E,styles:I,unstyled:S,className:o,style:y,vars:M,autoContrast:L,mod:k,...G}=t,N=h1(f),[W,K]=x1({value:l,defaultValue:i,finalValue:null,onChange:m}),U=q({name:"Tabs",props:t,classes:w,className:o,style:y,classNames:E,styles:I,unstyled:S,vars:M,varsResolver:j1});return e.jsx(v1,{value:{placement:T,value:W,orientation:c,id:N,loop:p,activateTabWithKeyboard:h,getTabId:D(`${N}-tab`,F),getPanelId:D(`${N}-panel`,F),onChange:K,allowTabDeactivation:x,variant:r,color:b,radius:j,inverted:B,keepMounted:_,unstyled:S,getStyles:U},children:e.jsx(z,{ref:a,id:N,variant:r,mod:[{orientation:c,inverted:c==="horizontal"&&B,placement:c==="vertical"&&T},k],...U("root"),...G,children:n})})});v.classes=w;v.displayName="@mantine/core/Tabs";v.Tab=$;v.Panel=R;v.List=O;/**
...
`,Z1=[{value:g.dashboard,label:"DASHBOARD"},{value:g.profile,label:"PROFILE"},{value:g.sponsorships,label:"SPONSORSHIPS"},{value:g.offerings,label:"OFFERINGS"},{value:g.stats,label:"STATS"},{value:g.newsfeed,label:"NEWSFEED"},{value:g.inbox,label:"INBOX"}];function G1(){const s=t1(),t=a1().pathname.split("/")[1];return e.jsx(F1,{children:e.jsx(v,{value:t,onChange:i=>s(`/${i}`),variant:"none",children:e.jsx(v.List,{children:Z1.map(i=>{const l=i.value.replace("/","");return e.jsx(v.Tab,{value:l,children:i.label},l)})})})})}function s2(){return console.log("PageLayout"),e.jsxs(e.Fragment,{children:[e.jsx(D1,{}),e.jsx(G1,{}),e.jsx(z,{mt:40,children:e.jsx(o1,{})})]})}export{s2 as default};
