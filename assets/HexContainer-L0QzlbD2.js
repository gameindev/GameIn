import{j as o,t as s,d as i}from"./index-KaOkpbgD.js";const l=a=>`${a/16}em`,t=i.div`
  --r: ${({$radius:a})=>a};
  --a: ${({$angle:a})=>a};

  width: ${({size:a})=>l(a)};
  background: ${({$background:a})=>a||s.colors.inputBgColor[0]};
  aspect-ratio: 1;
  position: relative;
  display: flex;
  align-items: center;
...
`,d=({children:a,radius:r=.25,angle:c="30deg",size:v="2",background:e})=>o.jsx(t,{size:v,$background:e,$radius:r,$angle:c,children:a});export{d as H};
