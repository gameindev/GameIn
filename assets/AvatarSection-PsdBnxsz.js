import{d as j,j as o,t as b}from"./index-Cpw8-sIN.js";import{H as $}from"./HexContainer-zaAX5gO8.js";import{R as A}from"./modal-dG7pnNlk.js";import{E as M}from"./EditAvator-R8CtVxb9.js";const y=({mainRadius:t=30,roundingRadius:e=10,rotated:n=!1,precision:s=20}={})=>{const g=60/s,p=t+e,i=a=>a*Math.PI/180,h=[];for(let a=0;a<6;a++){const r=a*60+(n?-90:0),x=50+p*Math.cos(i(r)),u=50+p*Math.sin(i(r));for(let c=0;c<=s;c++){const m=r+(c-s/2)*g,v=x+e*Math.cos(i(m)),f=u+e*Math.sin(i(m));h.push(`${v}% ${f}%`)}}return`polygon(${h.join(", ")})`},E=j.div`
