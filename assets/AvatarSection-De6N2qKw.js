import{k as b,j as o,x as g}from"./index-C5_jzTTu.js";import{H as $}from"./HexContainer-CKWSYepT.js";import{R as y}from"./modal-Dwyxegjm.js";import{E as A}from"./EditAvator-DUT1Cdlm.js";const M=({mainRadius:e=30,roundingRadius:t=10,rotated:n=!1,precision:s=20}={})=>{const x=60/s,h=e+t,a=i=>i*Math.PI/180,p=[];for(let i=0;i<6;i++){const r=i*60+(n?-90:0),u=50+h*Math.cos(a(r)),f=50+h*Math.sin(a(r));for(let c=0;c<=s;c++){const m=r+(c-s/2)*x,j=u+t*Math.cos(a(m)),v=f+t*Math.sin(a(m));p.push(`${j}% ${v}%`)}}return`polygon(${p.join(", ")})`},S=b.div`
