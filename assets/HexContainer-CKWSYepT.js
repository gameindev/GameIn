import{j as o,x as s,k as i}from"./index-C5_jzTTu.js";const l=a=>`${a/16}em`,t=i.div`
  --r: ${({$radius:a})=>a};
  --a: ${({$angle:a})=>a};
...
`,n=({children:a,radius:r=.25,angle:c="30deg",size:v="2",background:e})=>o.jsx(t,{size:v,$background:e,$radius:r,$angle:c,children:a});export{n as H};
