import{j as o,t as i,d as s}from"./index-DCh2P-fd.js";const t=a=>`${a/16}rem`,l=s.div`
  --r: ${({radius:a})=>a};
  --a: ${({angle:a})=>a};
...
`,d=({children:a,radius:r=.15,angle:c="30deg",size:v=280,background:e})=>o.jsx(l,{size:v,background:e,radius:r,angle:c,children:a});export{d as H};
