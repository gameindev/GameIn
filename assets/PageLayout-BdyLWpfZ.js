...
`,k1=[{value:g.DASHBOARD.ROOT,label:"DASHBOARD"},{value:g.PROFILE.ROOT,label:"PROFILE"},{value:g.SPONSORSHIPS.ROOT,label:"SPONSORSHIPS"},{value:g.OFFERINGS.ROOT,label:"OFFERINGS"},{value:g.STATS.ROOT,label:"STATS"},{value:g.NEWSFEED.ROOT,label:"NEWSFEED"},{value:g.INBOX.ROOT,label:"INBOX"}];function Z1(){const t=s1(),s=a1().pathname.split("/")[1];return e.jsx(U1,{children:e.jsx(v,{value:s,onChange:i=>t(`/${i}`),variant:"none",children:e.jsx(v.List,{children:k1.map(i=>{const l=i.value.replace("/","");return e.jsx(v.Tab,{value:l,children:i.label},l)})})})})}function a2(){return e.jsxs(e.Fragment,{children:[e.jsx(D1,{}),e.jsx(Z1,{}),e.jsx(V,{mt:40,children:e.jsx(o1,{})})]})}export{a2 as default};
