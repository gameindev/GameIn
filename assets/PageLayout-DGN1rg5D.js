import{f as P,u as V,j as e,B as z,e as J,U as X,x as Z,b as q,c as Q,y as Y,z as e1,v as C,k as d,n as s1,l as t1,w as a1,s as f,O as o1}from"./index-DUyVJtZo.js";import{c as i1,s as n1,A as r1,a as l1}from"./authSelector-DLEHvOLP.js";import{c as c1}from"./createLucideIcon-7bouigEo.js";import{T as u}from"./Text-CVPmmZEG.js";import{g as d1,U as m1}from"./user-round-CzlzNyJ8.js";import{B as U}from"./Button-bEuxfMpm.js";import{c as p1}from"./create-safe-context-DoVnqKbt.js";import{u as C1,a as h1,b as x1}from"./DirectionProvider-CoZl_09z.js";function D(s,a){return t=>{if(typeof t!="string"||t.trim().length===0)throw new Error(a);return`${s}-${t}`}}const[v1,A]=p1("Tabs component was not found in the tree");var w={root:"m_89d60db1","list--default":"m_576c9d4",list:"m_89d33d6d",tab:"m_4ec4dce6",panel:"m_b0c91715",tabSection:"m_fc420b1f",tabLabel:"m_42bbd1ae","tab--default":"m_539e827b","list--outline":"m_6772fbd5","tab--outline":"m_b59ab47c","tab--pills":"m_c3381914"};const g1={},O=P((s,a)=>{const t=V("TabsList",g1,s),{children:i,className:l,grow:m,justify:c,classNames:r,styles:p,style:g,mod:h,...x}=t,n=A();return e.jsx(z,{...x,...n.getStyles("list",{className:l,style:g,classNames:r,styles:p,props:t,variant:n.variant}),ref:a,role:"tablist",variant:n.variant,mod:[{grow:m,orientation:n.orientation,placement:n.orientation==="vertical"&&n.placement,inverted:n.inverted},h],"aria-orientation":n.orientation,__vars:{"--tabs-justify":c},children:i})});O.classes=w;O.displayName="@mantine/core/TabsList";const f1={},$=P((s,a)=>{const t=V("TabsPanel",f1,s),{children:i,className:l,value:m,classNames:c,styles:r,style:p,mod:g,keepMounted:h,...x}=t,n=A(),b=n.value===m,j=n.keepMounted||h||b?i:null;return e.jsx(z,{...x,...n.getStyles("panel",{className:l,classNames:c,styles:r,style:[p,b?void 0:{display:"none"}],props:t}),ref:a,mod:[{orientation:n.orientation},g],role:"tabpanel",id:n.getPanelId(m),"aria-labelledby":n.getTabId(m),children:j})});$.classes=w;$.displayName="@mantine/core/TabsPanel";const u1={},R=P((s,a)=>{const t=V("TabsTab",u1,s),{className:i,children:l,rightSection:m,leftSection:c,value:r,onClick:p,onKeyDown:g,disabled:h,color:x,style:n,classNames:b,styles:j,vars:B,mod:T,tabIndex:_,...E}=t,I=J(),{dir:S}=C1(),o=A(),y=r===o.value,M=k=>{o.onChange(o.allowTabDeactivation&&r===o.value?null:r),p==null||p(k)},L={classNames:b,styles:j,props:t};return e.jsxs(X,{...E,...o.getStyles("tab",{className:i,style:n,variant:o.variant,...L}),disabled:h,unstyled:o.unstyled,variant:o.variant,mod:[{active:y,disabled:h,orientation:o.orientation,inverted:o.inverted,placement:o.orientation==="vertical"&&o.placement},T],ref:a,role:"tab",id:o.getTabId(r),"aria-selected":y,tabIndex:_!==void 0?_:y||o.value===null?0:-1,"aria-controls":o.getPanelId(r),onClick:M,__vars:{"--tabs-color":x?Z(x,I):void 0},onKeyDown:i1({siblingSelector:'[role="tab"]',parentSelector:'[role="tablist"]',activateOnFocus:o.activateTabWithKeyboard,loop:o.loop,orientation:o.orientation||"horizontal",dir:S,onKeyDown:g}),children:[c&&e.jsx("span",{...o.getStyles("tabSection",L),"data-position":"left",children:c}),l&&e.jsx("span",{...o.getStyles("tabLabel",L),children:l}),m&&e.jsx("span",{...o.getStyles("tabSection",L),"data-position":"right",children:m})]})});R.classes=w;R.displayName="@mantine/core/TabsTab";const F="Tabs.Tab or Tabs.Panel component was rendered with invalid value or without value",b1={keepMounted:!0,orientation:"horizontal",loop:!0,activateTabWithKeyboard:!0,allowTabDeactivation:!1,unstyled:!1,inverted:!1,variant:"default",placement:"left"},j1=Q((s,{radius:a,color:t,autoContrast:i})=>({root:{"--tabs-radius":e1(a),"--tabs-color":Z(t,s),"--tabs-text-color":d1(i,s)?Y({color:t,theme:s,autoContrast:i}):void 0}})),v=P((s,a)=>{const t=V("Tabs",b1,s),{defaultValue:i,value:l,onChange:m,orientation:c,children:r,loop:p,id:g,activateTabWithKeyboard:h,allowTabDeactivation:x,variant:n,color:b,radius:j,inverted:B,placement:T,keepMounted:_,classNames:E,styles:I,unstyled:S,className:o,style:y,vars:M,autoContrast:L,mod:k,...G}=t,N=h1(g),[W,K]=x1({value:l,defaultValue:i,finalValue:null,onChange:m}),H=q({name:"Tabs",props:t,classes:w,className:o,style:y,classNames:E,styles:I,unstyled:S,vars:M,varsResolver:j1});return e.jsx(v1,{value:{placement:T,value:W,orientation:c,id:N,loop:p,activateTabWithKeyboard:h,getTabId:D(`${N}-tab`,F),getPanelId:D(`${N}-panel`,F),onChange:K,allowTabDeactivation:x,variant:n,color:b,radius:j,inverted:B,keepMounted:_,unstyled:S,getStyles:H},children:e.jsx(z,{ref:a,id:N,variant:n,mod:[{orientation:c,inverted:c==="horizontal"&&B,placement:c==="vertical"&&T},k],...H("root"),...G,children:r})})});v.classes=w;v.displayName="@mantine/core/Tabs";v.Tab=R;v.Panel=$;v.List=O;/**
