...
`,M=({avatar:e,size:t,className:s=""})=>x.jsx("div",{className:s,children:x.jsx(v,{$mainRadius:10,$roundingRadius:15,size:t,$backgroundColor:j.colors.inputBgColor[0],$rotated:!0,children:x.jsx("img",{src:e,alt:"Avatar"})})}),S="/GameIn/assets/creator_image-DN7rJn_7.jpg",T=e=>{var t,s;return(s=(t=e.user)==null?void 0:t.profile)==null?void 0:s.user},_=e=>{var t;return!!((t=e.auth)!=null&&t.accessToken)};export{M as A,v as H,S as a,H as c,b as f,_ as i,T as s};
