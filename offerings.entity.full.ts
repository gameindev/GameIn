...
// The following imports may be missing or have incorrect paths. Please ensure the files exist and the paths are correct.
import { UploadEntity } from "src/uploads/upload.entity";
import { User } from "src/users/user.entity";
import { OfferingType } from "src/offerings/enums/offering-type.enum";
...
import { OfferingPrice } from "src/offerings/offering-price/offering-price.entity";
