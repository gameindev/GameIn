...
import { calculatePriceBreakdown, DateField, SelectField, TextField } from "../../../shared/utils/helpers/opportunityForm.helper";
import { InlineFields, OfferingOpportunities } from "../styles/opportunity-styles";
...
import { Checkbox, Flex, NumberInput, Space, Stack, Text, Textarea } from "@mantine/core";
        ...
        terms: [
            {
                ...
                Component: Checkbox,
                required: { value: true, message: "Please accept the terms before continuing" },
                componentProps: {
