...
import { Paper, Text, Avatar, Group, Box, Button, Image, Badge, ActionIcon, Loader } from "@mantine/core";
import { IconEdit, IconDownload, IconFile, IconPhoto, IconFileText, IconFileZip, IconClock, IconCheck, IconChecks } from "@tabler/icons-react";
        ...
        >
            <Group spacing="xs" mb={5} justify="space-between" w="100%">
                <Group>
                    ...
                    <Text size="xs" color={theme.colors.inputBgColor[0]}>{message.sender || "User"}</Text>
                </Group>
                <Group spacing={4}>
                                    ...
                                    {isImage ? (
                                        <Box>
                                            ...
                                            <Group position="apart">
                                                <Text size="xs" color={isCurrentUser ? "rgba(255,255,255,0.7)" : "#ADB5BD"} lineClamp={1}>
                                                    {attachment.name}
                                                </Text>
                                                <ActionIcon
                                                    size="xs"
