import { ActionIcon, Box, Collapse, Flex, Group, Image, Text } from "@mantine/core";
import HexContainer from "../../../shared/components/HexContainer";
import { Separator } from "../utils/separators";
import IconButton from "../../../shared/components/IconButton";
import { IconChevronDown, IconChevronUp, IconDeviceFloppy, IconFile, IconMessage, IconX } from "@tabler/icons-react";
    ...
    return (
        <Box>
            ...
            >
                ...
                <Box flex={2.35}>
                    <Text fz={theme.fontSizes.sm}>
                        {sponsorship?.description || "Sponsorship contract description, etc"}
                    </Text>
                </Box>
                <Separator />
                ...
                <Box flex={1.65}>
                    <Group gap="0.3em">
                        ...
                        <IconButton iconSize={18} Icon={IconMessage} hoverClass="hoverGrey" />
