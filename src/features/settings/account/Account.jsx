...
import { Grid, Textarea, TextInput, Title, Select, Button, Space, PasswordInput, Text } from "@mantine/core";
...
const Account = () => {
    ...
    const updateAccount = useUpdateAccount(setAccountError, dispatch, setUser, user);
    const updatePassword = useUpdatePassword(setPasswordError, setConfirmPasswordError);
            ...
            <SettingsWrap>
                <SettingsCard>
                    ...
                    <Grid gutter="md">
                        ...
                        {accountError && (
                            <Grid.Col span={12}>
                                <Text c="red" size="sm">{accountError}</Text>
                            </Grid.Col>
                        )}
