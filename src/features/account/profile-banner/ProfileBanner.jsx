import { ActionWrapper, BannerWrapper, ProfileWrapper, UserAvatar, UserInformation } from "./styles/style";
...
export default function ProfileBanner({ userProfile, isSelf }) {
    ...
    const { user_type, creator_profile, brand_profile, community_profile } = userProfile;
