...
import { IconHeartHandshake, IconMessage, IconPlus, IconUserCheck } from "@tabler/icons-react";
...
export const Tableview = () => {
    ...
    const rows = filteredSearchData.map((userItem) => {
        const { id, username, isVerified } = userItem;
        ...
        return (
            <Table.Tr key={id}>
                ...
                <Table.Td>
                    <Group>
                        <IconButton size="22" Icon={IconMessage} hoverClass="hoverYellow" iconSize="12" />
                        ...
                        <ActionIcon color="primary" size="sm" variant="filled" radius="md">
                            <Text size="10" style={{ color: "#363a3e", fontWeight: "bold" }}>S</Text>
                        </ActionIcon>
                    </Group>
                </Table.Td>
            </Table.Tr>
