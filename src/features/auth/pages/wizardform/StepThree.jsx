import { Box, Button, Group, Input, Loader, Stack } from "@mantine/core";
import { useFormStep } from "../../hooks/useFormStep";
import ReCAPTCHA from "react-google-recaptcha";
import { stepThreeValidationSchema } from "../../schema/stepThreeValidation";
        ...
        <Stack spacing="xl" align="center">
            ...
            <Group position="apart" mt="xl" style={{ justifyContent: "center" }}>
                ...
                <Button variant="primary" onClick={handleSubmit}>
                    {isSubmitting ? (
                        <Loader type="dots" size="sm" color="#333" />
                    ) : (
                        "Submit"
                    )}
                </Button>
