    ...
    styles: (theme, params) => ({
        ...
        input: {
            ...
            '&[data-checked]': {
                ...
                // Force apply checked state styles
                // Mantine now recommends using !important in custom themes for forced overrides
            ...
            '&:focus': {
                outline: `2px solid ${theme.colors.primary[5] || theme.colors.primary[0]}`,
                outlineOffset: "2px",
            },
            '&[dataDisabled]': {
            ...
            styles: (theme, params) => {
                ...
                return {
                    input: {
                        fontSize: size ? theme.fontSizes?.[size] : theme.fontSizes.md,
                        color: theme.white,
                        backgroundColor: theme.colors?.[variant]?.[0] ?? theme.colors.inputBgColor[0],
                        padding: `${theme.spacing?.[size]}`,
                        borderRadius: theme.radius.md,
                        height: "auto",
                        lineHeight: "normal",
