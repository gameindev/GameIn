...
import { Group, TextInput, Switch, Button, Text, Divider, NativeSelect, } from "@mantine/core"
...
import { Gamepad2, Instagram, Music2, Twitch, Twitter, User, Youtube } from "lucide-react";
...
export default function SearchByUserType() {
  ...
  return (
    ...
    <SearchStyles>
      ...
      <form>
        <Group justify="space-between">
          <Group className="forms-fields">
            {fields.map(({name, className, variant, label, placeholder, rightSection, component, componentType, options}) => (
              <FormField
                key={name}
                name={name}
                control={control}
      ...
      {/* <Listview SocialInfo={SocialInfo} />
      <Divider my="sm" variant="dashed" color="white" /> */}
      {/* <Group> */}
        {view && viewList[view]}
        {/* <div style={{flexBasis: `calc(33.3% - 0.8em)`}}><Gridview SocialInfo={SocialInfo} /></div>
        <div style={{flexBasis: `calc(33.3% - 0.8em)`}}><Gridview SocialInfo={SocialInfo} /></div>
        <div style={{flexBasis: `calc(33.3% - 0.8em)`}}><Gridview SocialInfo={SocialInfo} /></div> */}
      {/* </Group> */}
      {/* <Divider my="sm" variant="dashed" color="white" />
