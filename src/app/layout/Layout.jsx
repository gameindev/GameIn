...
import { startInactivityTracker, stopInactivityTracker } from "../services/token/inactivityTracker";
...
const Layout = () => {
    ...
    useEffect(() => {
        const fetchUser = async () => {
            ...
            try {
                const userData = await getUserProfileService(get, user.id, user.accessToken, user.user_type);
