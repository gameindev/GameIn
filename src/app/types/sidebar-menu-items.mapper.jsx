...
export const sidebarItems = [
  {
    ...
    label: "Account",
    active: false,
    defaultLink: routePaths.ACCOUNTS.DASHBOARD.ROOT,
    link: [
      routePaths.ACCOUNTS.DASHBOARD.ROOT,
      routePaths.ACCOUNTS.PROFILE.ROOT,
      routePaths.ACCOUNTS.INBOX.ROOT,
      routePaths.ACCOUNTS.SPONSORSHIPS.ROOT,
      routePaths.ACCOUNTS.OFFERINGS.ROOT,
      routePaths.ACCOUNTS.STATS.ROOT,
    ],
  },
  {
